...
import com.dtd.letsgodubki.MVP.modelImpl.FirstActivityModelImpl;
import com.dtd.letsgodubki.MVP.presenter.FirstActivityPresenter;
import com.dtd.letsgodubki.MVP.presenterImpl.FirstActivityPresenterImpl;
...
import com.dtd.letsgodubki.MVP.viewImpl.FirstActivityViewImpl;
import com.dtd.letsgodubki.R;
...
public class FirstActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirstActivityViewHolder firstActivityViewHolder = new FirstActivityViewHolder(
                (TextView) findViewById(R.id.tv7),
                (TextView) findViewById(R.id.tv9_1),
                (TextView) findViewById(R.id.tv9_2),
                (ImageView)findViewById(R.id.img7),
                (ImageView)findViewById(R.id.img91),
                (ImageView)findViewById(R.id.img92),
                (Button) findViewById(R.id.btn7),
                (Button) findViewById(R.id.btn9_1),
                (Button) findViewById(R.id.btn9_2)
        );

        final FirstActivityModel firstActivityModel = new FirstActivityModelImpl(firstActivityViewHolder);
        final FirstActivityView firstActivityView = new FirstActivityViewImpl(this,firstActivityViewHolder);

        firstActivityPresenter = new FirstActivityPresenterImpl(firstActivityModel, firstActivityView);

        firstActivityPresenter.onCreate(this, savedInstanceState);
    }
